...
Usage:
  python main_scm_qmoe_qels.py --dataset_name HateMM --num_runs 200 --seed_offset 0
"""
...
def setup_logger(tag=""):
    ...
    lf = f"./logs/scm_qmoe_qels_{tag}_{ts}.log"
...
def main():
    ...
    save_dir = f"./seed_search_scm_qmoe_qels/{tag}_off{args.seed_offset}"
