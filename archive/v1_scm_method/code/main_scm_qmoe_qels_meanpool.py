...
Usage:
  python main_scm_qmoe_qels_mp.py --dataset_name HateMM --num_runs 200 --seed_offset 0
"""
...
def setup_logger(tag=""):
    ...
    lf = f"./logs/scm_qmoe_qels_mp_{tag}_{ts}.log"
...
def main():
    ...
    logger.info(f"=== SCM Q-MoE+QELS: {tag}, Runs: {args.num_runs}, eps_min={args.eps_min}, eps_lambda={args.eps_lambda} ===")
    ...
    save_dir = f"./seed_search_scm_qmoe_qels_mp/{tag}_off{args.seed_offset}"
